...
*** On Operation system choose Red Hat Enterprise Linux 10.1
...
To keep usernames and permissions the same for the rest of the lab, we will set up a user called `rhel`
...
SHA256:5Z8GpqUSojEcZWvtspDVefI5YIVajUr3+HTVi3HcE+4 rhel@bastion.fnlng.internal
...
Now we want to send our public key to the  rhel user on the node1 machine.
